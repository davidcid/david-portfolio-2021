            ...
            <div className="container">
                <div className="technologies">
                    ...
                    <ul className="skills-list">
                        <li className="skills-element"><AiFillHtml5 /><p>HTML5</p></li>
                        <li className="skills-element"><DiCss3 /><p>CSS3</p></li>
                        <li className="skills-element"><DiSass /><p>Sass</p></li>
                ...
                <div className="tools">
                    <h2>Herramientas</h2>
                    <ul className="skills-list">
                        <li className="skills-element"><FaGithub /><p>Github</p></li>
                        ...
                        <li className="skills-element"><FaSlack /><p>Slack</p></li>
                        <li className="skills-element"><FaTrello /><p>Trello</p></li>
                    </ul>
                </div>
            </div>
        </div>
